...
class TextConfigureApp(tk.Frame):
    ...
    def create_widgets(self):
        ...
        label_text = tk.Label(text_frame, text = "Type text here: ", 
                              padx = 10, pady = 10)
